...
const BASELINES = {
  ...
  inlineTsxStyles: 229, // style={{…}} in TSX; many are legit dynamic values (banked from 500 — the count had drifted far below the old ceiling)
};
