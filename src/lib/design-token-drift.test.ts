...
const BASELINES = {
  ...
  offScaleSpacingPx: 1664, // +11: live call transcript + reader (cave-zr9dx, a411e3bcf3) — CI went red on main because this landed without raising the ratchet. Every added value is the micro-mark family the GitHub-triage entry below already banks: 6px glyph-to-label gaps on the transcript's speaker chips and control row (--space-2 pushes an icon off its word), 6px inline padding on the sub-20px state pills, 2px nudges on the caption strip and highlight tick, and the reader's 52px sticky offset (the measured header height, not a spacing step). Snapping these to --space-1/-2 turns a 17-19px pill into a lozenge, which is the one shape these marks must not be. Every font-size in both sheets is on the type scale and tokenize-css.mjs is a no-op over them. // -65: banked — the familiar-analytics workbench rebuild (cave-l4ttp) snapped the mock's 5/6/7/9/10/11/13/14/15/18/22/26px paddings and gaps to --space-1..-6 across the whole new sheet, and retiring the old page's section/KPI/hero chrome reclaimed the rest. What remains in the sheet is only the 1/2/3px micro-mark family (badge padding, tick nudges) the earlier handoffs already banked. +4: GitHub triage stream + detail rebuild ("Cody Github.dc.html" handoff) — the mock's 5/7/9/10/11/13/14px paddings and gaps were ALL snapped to --space-1..-4 in this PR, so what remains is only the micro-mark family the Chart Room, Weaves, Review Deck and GitHub-composer handoffs already banked: 6px glyph-to-label gaps (8px separates an icon from its word, which is exactly what a stage badge, a signal chip and a gate label must not do), 6px inline padding on the 17-19px stage badges and row verbs (--space-2 turns a 17px pill into a lozenge), and the 2/3px nudges on the signal strip, the peek margin and the facts column. Retiring the table and the old glass masthead reclaimed most of what the two new sheets added, which is why this is +4 rather than the +40 they started at; every font-size in both sheets is on the type scale (-5 banked above) and tokenize-css.mjs is a no-op over them. — the familiar-analytics workbench rebuild (cave-l4ttp) snapped the mock's 5/6/7/9/10/11/13/14/15/18/22/26px paddings and gaps to --space-1..-6 across the whole new sheet, and retiring the old page's section/KPI/hero chrome reclaimed the rest. What remains in the sheet is only the 1/2/3px micro-mark family (badge padding, tick nudges) the earlier handoffs already banked. +4: GitHub triage stream + detail rebuild ("Cody Github.dc.html" handoff) — the mock's 5/7/9/10/11/13/14px paddings and gaps were ALL snapped to --space-1..-4 in this PR, so what remains is only the micro-mark family the Chart Room, Weaves, Review Deck and GitHub-composer handoffs already banked: 6px glyph-to-label gaps (8px separates an icon from its word, which is exactly what a stage badge, a signal chip and a gate label must not do), 6px inline padding on the 17-19px stage badges and row verbs (--space-2 turns a 17px pill into a lozenge), and the 2/3px nudges on the signal strip, the peek margin and the facts column. Retiring the table and the old glass masthead reclaimed most of what the two new sheets added, which is why this is +4 rather than the +40 they started at; every font-size in both sheets is on the type scale (-5 banked above) and tokenize-css.mjs is a no-op over them.
