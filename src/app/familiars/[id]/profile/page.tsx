...
// /familiars/[id]/profile duplicated /dashboard/familiars/[id]/profile
...
// keep working.
export default async function FamiliarProfileRedirectPage({
  params,
  searchParams,
}: {
  ...
  redirect(`/dashboard/familiars/${encodeURIComponent(id)}/profile${suffix}`);
}
