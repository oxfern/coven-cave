...
// Register the trimmed chrome + glyph subsets instead of the full ~9k-icon,
// 4.25 MB "@iconify-json/ph/icons.json" (this dev mockup renders free-form
// icon names, so cover both subsets). Generated by generate-icon-subset.mjs.
...
function ensurePhRegistered() {
  ...
  addCollection(phChrome as Parameters<typeof addCollection>[0]);
