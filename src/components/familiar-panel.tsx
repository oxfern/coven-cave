...
export const FamiliarPanel = forwardRef<ChatRouterHandle, Props>(function FamiliarPanel(
  ...
  return (
    <div className="flex h-full min-h-0 flex-col">
      {!familiar ? (
        <div className="flex flex-1 flex-col items-center justify-center px-6 text-center text-[length:var(--text-sm)] text-[var(--text-muted)]">
          ...
          <button
            ...
            className="mt-4 rounded-md border border-[var(--border-hairline)] bg-[var(--bg-raised)] px-3 py-1 text-[length:var(--text-xs)] text-[var(--text-primary)] hover:bg-[var(--bg-raised)]/80"
          >
            Open setup
          </button>
        </div>
