    ...
    <section className="flex h-full min-w-0 flex-col bg-background text-foreground">
      <div className="flex-1 overflow-y-auto">
        <div className="mx-auto w-full max-w-[1280px] px-4 pb-12 pt-5 sm:px-8">
          <div className="mb-4">
            <p className="text-[length:var(--text-xs)] font-semibold uppercase tracking-widest text-muted-foreground">
              OpenCoven
            </p>
            <h2 className="mt-1 text-[length:var(--text-xl)] font-semibold text-[var(--text-primary)]">
